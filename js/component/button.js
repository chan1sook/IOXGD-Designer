addComponent({
  ...
  render: {
    ...
    update: function (element) {
      ...
      $(element).css({
        ...
        background:
          +this.property.rel_grad_dir === 0
            ? this.property.rel_main_color
            : `linear-gradient(${
                +this.property.rel_grad_dir === 1 ? "90" : "180"
              }deg, ${this.property.rel_main_color} 0%, ${
                this.property.rel_grad_color
              } 100%)`,
  ...
  build: async function (simulator, pagename, output_path) {
    ...
    code += `${this.property.name} = lv_btn_create(${
    ...
    code += `lv_btn_set_checkable(${this.property.name}, ${
      +this.property.toggle === 1 ? "true" : "false"
    });\n`;
    code += `\n`;
    code += `lv_obj_set_style_local_bg_color(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.rel_main_color.substring(
      1
    )}));\n`;
    code += `lv_obj_set_style_local_bg_grad_color(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.rel_grad_color.substring(
      1
    )}));\n`;
    code += `lv_obj_set_style_local_bg_grad_dir(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, ${
      indexGradDir2Var[+this.property.rel_grad_dir]
    });\n`;
    code += `lv_obj_set_style_local_border_color(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.border_color.substring(
      1
    )}));\n`;
    ...
    code += `lv_obj_set_style_local_bg_color(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_PRESSED, lv_color_hex(0x${this.property.pr_main_color.substring(
      1
    )}));\n`;
    code += `lv_obj_set_style_local_bg_grad_color(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_PRESSED, lv_color_hex(0x${this.property.pr_grad_color.substring(
      1
    )}));\n`;
    code += `lv_obj_set_style_local_bg_grad_dir(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_PRESSED, ${
      indexGradDir2Var[+this.property.pr_grad_dir]
    });\n`;
    code += `lv_obj_set_style_local_border_color(${
      this.property.name
    }, LV_BTN_PART_MAIN, LV_STATE_PRESSED, lv_color_hex(0x${this.property.border_color.substring(
      1
    )}));\n`;
    ...
    code += `lv_obj_set_style_local_text_color(${
      this.property.name
    }_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.color.substring(
      1
    )}));\n`;
    code += `lv_obj_set_style_local_text_font(${
      this.property.name
    }_label, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &${
