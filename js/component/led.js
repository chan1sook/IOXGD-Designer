addComponent({
  ...
  build: async function (simulator, pagename, output_path) {
    ...
    code += `${this.property.name} = lv_led_create(${
    ...
    code += `lv_obj_set_style_local_bg_color(${
      this.property.name
    }, LV_LED_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.main_color.substring(
      1
    )}));\n`;
    code += `lv_obj_set_style_local_bg_grad_color(${
      this.property.name
    }, LV_LED_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.grad_color.substring(
      1
    )}));\n`;
    code += `lv_obj_set_style_local_bg_grad_dir(${
      this.property.name
    }, LV_LED_PART_MAIN, LV_STATE_DEFAULT, ${
    ...
    code += `lv_obj_set_style_local_border_color(${
      this.property.name
    }, LV_LED_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.border_color.substring(
      1
    )}));\n`;
    ...
    code += `lv_obj_set_style_local_shadow_color(${
      this.property.name
    }, LV_LED_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x${this.property.shadow_color.substring(
      1
    )}));\n`;
