    ...
    submenu: [
      ...
      },
      {
        ...
        click: async () => {
          ...
          return loadProject(OpenfilePath, () => {
            ...
            $("#status").text(
              `Open file ${OpenfilePath} at ${new Date().toLocaleTimeString(
                "th-TH"
              )}`
            );
          });
      ...
      },
      {
        ...
        click: async () => {
          ...
          return saveProject(OpenfilePath, () => {
            $("#status").text(
              `Save file to ${OpenfilePath} at ${new Date().toLocaleTimeString(
                "th-TH"
              )}`
            );
          });
      ...
      },
      {
        ...
        click: async () => {
          let result = await dialog.showSaveDialog({
            defaultPath:
              typeof OpenfilePath !== "undefined" ? OpenfilePath : "",
            filters: [
              {
                name: "GD",
                extensions: ["gd"],
          ...
          return saveProject(OpenfilePath, () => {
            $("#status").text(
              `Save as to ${OpenfilePath} at ${new Date().toLocaleTimeString(
                "th-TH"
              )}`
            );
          });
  ...
  },
  {
    ...
    submenu: [
      ...
      },
      {
        label: "Report Issue",
        click: () =>
          shell.openExternal("https://github.com/ioxgd/IOXGD-Designer/issues"),
      },
      { type: "separator" },
      {
